...
## FNC: "PANDAS" SUBPLOTS ##
############################
def mmp_inner_subplot(data, x, main_logo_source, proj_logo_source, traces_params, layout_params, axes_params):
...
#############################
def mmp_plot(data=None, kind='line', x=None, y=None, z=None, show=True, main_logo_source=None, proj_logo_source=None,
